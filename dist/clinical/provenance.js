...
exports.NOT_ESTABLISHED_PHRASES = exports.SECTION_IDS = exports.SECTIONS = exports.StructuredExtractionSchema = exports.ReviewFlagSchema = exports.ReviewFlagType = exports.ClinicalFactSchema = exports.MeasurementSchema = exports.AssessmentStatus = exports.Laterality = exports.Certainty = exports.SourceType = void 0;
 ...
 */
exports.Certainty = zod_1.z.enum([
    'CONFIRMED',
    'REPORTED',
    'OBSERVED',
    'MEASURED',
...
exports.Laterality = zod_1.z.enum(['LEFT', 'RIGHT', 'BILATERAL', 'MIDLINE', 'NOT_APPLICABLE', 'UNSPECIFIED']);
exports.AssessmentStatus = zod_1.z.enum([
    'ESTABLISHED',
...
exports.MeasurementSchema = zod_1.z.object({
    ...
    laterality: exports.Laterality.default('UNSPECIFIED')
});
/**
 ...
 */
exports.ClinicalFactSchema = zod_1.z.object({
    section_id: zod_1.z.string(),
    field_id: zod_1.z.string(),
    value: zod_1.z.string(),
    source_type: exports.SourceType,
    certainty: exports.Certainty,
    laterality: exports.Laterality.default('UNSPECIFIED'),
    /** Onset, duration, frequency, progression, or when it last occurred. */
    time_reference: zod_1.z.string().nullable().optional(),
    measurement: exports.MeasurementSchema.nullable().optional(),
    /** Verbatim words from the transcript that support this fact. */
    source_quote: zod_1.z.string(),
    assessment_status: exports.AssessmentStatus.default('ESTABLISHED'),
    requires_review: zod_1.z.boolean().default(false),
    review_reason: zod_1.z.string().nullable().optional(),
    clinician_approved: zod_1.z.boolean().default(false),
    /** Set when this fact contradicts another; both are kept. */
    contradicts: zod_1.z.string().nullable().optional()
});
exports.ReviewFlagType = zod_1.z.enum([
    'CONTRADICTION',
...
exports.ReviewFlagSchema = zod_1.z.object({
    flag_type: exports.ReviewFlagType,
    description: zod_1.z.string(),
    section_id: zod_1.z.string().nullable().optional(),
    source_quotes: zod_1.z.array(zod_1.z.string()).default([]),
 ...
 */
exports.StructuredExtractionSchema = zod_1.z.object({
    facts: zod_1.z.array(exports.ClinicalFactSchema),
    review_flags: zod_1.z.array(exports.ReviewFlagSchema).default([]),
    /** Sections the model looked for and found nothing on. Recorded, not silently omitted. */
    sections_not_discussed: zod_1.z.array(zod_1.z.string()).default([])
});
/**
...
exports.SECTION_IDS = exports.SECTIONS.map((s) => s.id);
function getSection(id) {
    return exports.SECTIONS.find((s) => s.id === id);
}
/** Phrases the template sanctions when information genuinely was not established. */
exports.NOT_ESTABLISHED_PHRASES = {
    CONFIRMED: null,
    REPORTED: null,
    OBSERVED: null,
    MEASURED: null,
